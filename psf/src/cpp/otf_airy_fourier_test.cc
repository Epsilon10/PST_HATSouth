...
/**
 * This script was simply to verify that the optical transfer function is indeed the fourier transform of the airy disk function
 * Numerically performs the convolution integral, obviously not the most performant method but the most straightforward  
*/
